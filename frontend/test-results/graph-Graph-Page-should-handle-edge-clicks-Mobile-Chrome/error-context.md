...
Call log:
  - waiting for getByTestId('graph-canvas')
    - locator resolved to <div data-testid="graph-canvas" class="w-full h-full bg-white border rounded-lg flex-1">…</div>
  - attempting click action
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <div class="h-full flex flex-col p-4 space-y-4 overflow-y-auto">…</div> from <div class="transition-all duration-300 w-80 ↵        overflow-hidden bg-white border-l border-gray-200 z-10">…</div> subtree intercepts pointer events
